...
const DropZone = styled(Box)({
  ...
  // Added fetchActionDocumentList and actionID by Gauri to pass actionID and refresh list on 28 Feb 2025
const DocumentsComponentA = ({
  initiativeDocument,
  fetchActionDocumentList,
  initiativesID,
  actionID,
  setRefresh,
  refresh,
  ...
  // Added by Gauri to bind Doc History data on 28 Feb 2025
    const [documentHistoryData, setDocumentHistoryData] = useState(null);
  const [fileName, setFileName] = useState("");
  console.log("DocumentsComponent111", refresh);
  console.log("DocumentsComponent111 initiativeDocument", initiativeDocument);
  const toggleDrawer = () => {
  ...
  // Modified by Gauri to Attach URL in list view on 28 Feb 2025
  const uploadAttachURL = async () => {
    ...
    // Commented and Modified URL by Gauri on 28 Feb 2025
    // const apiUrl = `${
    //   process.env.REACT_APP_BASEURL_ACCESS_CONTROL1
    // }/api/FileUpDown/IniAttachURL?=
  ...
  // Modified by Gauri to Upload Document in list view on 28 Feb 2025
  const handleDocumentUpload = async () => {
    ...
    try {
      // const response = await fetch(`${process.env.REACT_APP_BASEURL_ACCESS_CONTROL1}/api/FileUpDown/IniDocUpload?
  ...
  // Modified by Gauri to Delete Document in list view on 28 Feb 2025
  const handleDocDelete = (docId) => {
    ...
    const apiUrl = `${process.env.REACT_APP_BASEURL_ACCESS_CONTROL1}/api/InitiativeList/DeleteActionItemDocument?ActionItemID=${actionID}&DocumentID=${docId}&UserID=${userId}`;
  ...
  // Modified by Gauri to Bind Document History in list view on 28 Feb 2025
  ...
  return (
    <div className="tab-pane" id="Ini_Documents">
      ...
      <Table responsive striped bordered hover style={{ marginTop: "20px" }}>
        ...
        <tbody>
         {/* Modified by Gauri to fetch documents list view on 28 Feb 2025 */}
          ...
          {show !== 0 && (
            <>
              <Stack className="mb-3" horizontalAlign="end">
                <Button variant="contained" onClick={handleDocumentUpload}>
                  Upload
                </Button>
...
export default DocumentsComponentA;
