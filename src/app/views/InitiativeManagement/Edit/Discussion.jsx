...
const Discussion = ({ initiativeId, commentDrawerOpen, setCommentDrawerOpen }) => {
  ...
  return (
    <Box sx={{ padding: 2 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
        ...
        <Typography variant="body1">
          <strong>Initiative Code:</strong> <span className="text-danger">{id1?.demandCode}</span>
        </Typography>
      </Box>
      <Divider />
