...
const GetInitiativeHistory12 = async (initiativeId, currentPage, selectedActionType) => {
  ...
  try {
    ...
    const response = await axios.get(
      `${process.env.REACT_APP_BASEURL_ACCESS_CONTROL1}/api/InitiativeDetail/InitiativeShowHistory`,
      {
        params: { IdeaID: initiativeId, PageNo },
        headers: {
...
export default GetInitiativeHistory12;
